                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="date" type="date" class="form-control" value="{{ old('date') ? old('date') : $record->date}}" >
                                </div> 
                                <div class="form-group">
                                        ...
                                        @foreach ($services as $service)
                                            ...
                                            @foreach ($service->subservices as $subservice)
                                                <option value="{{ $subservice->id }}" 
                                                    @if (old('subservice_id'))
                                                        {{ old('subservice_id') == $subservice->id ? 'selected' : '' }} 
                                                    @else
                                                        {{ $record->subservice_id == $subservice->id ? 'selected' : '' }}            
                                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="place" type="text" class="form-control" value="{{ old('place') ? old('place') : $record->place}}" >
                                </div>
                                <div class="form-group">
